package com.helencoder.nlp.word2vec;
...
public class Word2VecUptrainingExample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        String filePath = new ClassPathResource("word2vec/raw_sentences.txt").getFile().getAbsolutePath();
         ...
         */
        WordVectorSerializer.writeWord2VecModel(vec, "model.txt");
         ...
         */
        Word2Vec word2Vec = WordVectorSerializer.readWord2VecModel("model.txt");
