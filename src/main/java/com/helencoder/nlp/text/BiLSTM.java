...
import com.helencoder.recurrent.character.CharacterIterator;
 ...
 *
 * Created by helencoder on 2017/12/18.
 */
public class BiLSTM {

    //private static final Logger log = LoggerFactory.getLogger(BiLSTM.class);
    ...
    public static void main( String[] args ) throws Exception {
        ...
        int generateSamplesEveryNMinibatches = 2;  //How frequently to generate samples from the network? 1000 characters / 50 tbptt length: 20 parameter updates per minibatch
        ...
        for( int i=0; i<numEpochs; i++ ){
            while(iter.hasNext()){
                System.out.println(miniBatchNumber);
                DataSet ds = iter.next();
                net.fit(ds);
                if(++miniBatchNumber % generateSamplesEveryNMinibatches == 0){
                    System.out.println(150613);
                    System.out.println("--------------------");
    ...
    public static CharacterIterator getShakespeareIterator(int miniBatchSize, int sequenceLength) throws Exception {
        ...
        //String fileLocation = "Shakespeare.txt";	//Storage location from downloaded file
        String fileLocation  = new ClassPathResource("Shakespeare.txt").getFile().getPath();
